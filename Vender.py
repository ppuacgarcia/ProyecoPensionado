...
class Vender:
    def __init__(self,vs):
        ...
        posx=430
        posy=100
        fVent = Frame(sw,width=500,height=350,bg=hiColor)
        fVent.place(x=0, y=0)
        #botones
        AddComida1= btn(350,celHt+20, '+', '#FFFFFF', colorbg, Cmd1Tp1, 'Arial', 12,'bold',10,1)
        AddComida2= btn(350,celHt*2+22, '+', '#FFFFFF', colorbg, Cmd1Tp2, 'Arial', 12,'bold',10,1)
        AddComida3= btn(350,celHt*3+24, '+', '#FFFFFF', colorbg, Cmd1Tp3, 'Arial', 12,'bold',10,1)
        AddComida4= btn(350,celHt*4+26, '+', '#FFFFFF', colorbg, Cmd2Tp1, 'Arial', 12,'bold',10,1)
        AddComida5= btn(350,celHt*5+28, '+', '#FFFFFF', colorbg, Cmd2Tp2, 'Arial', 12,'bold',10,1)
        AddComida6= btn(350,celHt*6+30, '+', '#FFFFFF', colorbg, Cmd2Tp3, 'Arial', 12,'bold',10,1)
        AddComida7= btn(350,celHt*7+32, '+', '#FFFFFF', colorbg, Cmd3Tp1, 'Arial', 12,'bold',10,1)
        AddComida8= btn(350,celHt*8+34, '+', '#FFFFFF', colorbg, Cmd3Tp2, 'Arial', 12,'bold',10,1)
        AddComida9= btn(350,celHt*9+36, '+', '#FFFFFF', colorbg, Cmd3Tp3, 'Arial', 12,'bold',10,1)
        #Tabla
        tabladata = ttk.Treeview(fVent)
        tabladata=ttk.Treeview(fVent,columns=("col1","col2"), height=14)
